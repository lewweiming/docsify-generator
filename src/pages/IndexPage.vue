<template>
  <q-page class="q-pa-lg flex flex-center">
    ...
    <div class="column items-center">
      <div>
        <!-- <q-icon id="documentSVG" size="150px" name="img:assets/icons/documents.svg" /> -->
        <svg width="200px" height="200px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path stroke="#A755C2" stroke-dasharray="5" stroke-width="0.5"
          ...
          <path stroke="#A755C2" stroke-dasharray="5" stroke-width="0.5"
            ...
            fill="none" />
          <path stroke="#6622CC" stroke-dasharray="5" stroke-width="0.5" fill-rule="evenodd" clip-rule="evenodd"
      ...
      <div class="sacramento-regular text-h2 exo-bold text-primary">
        Docsify AI Generator
      </div>
      <div class="sacramento-regular text-h4 font-bold text-center text-accent q-my-md">
        Generate Smart Documents with AI
      </div>
      <p class="text-center text-h6 italic">
        Automate content creation. Save time. Publish effortlessly.
      </p>
      ...
      <div class="q-my-lg text-h6 text-center">Powered by AI@Webconxept + Google Gemini</div>
    </div>
